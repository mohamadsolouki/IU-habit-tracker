...
db = db.Database("db_files/test.db")
...
def test_add_habit():
    hb.add_habit("Study", 1, '2023-01-01 01:00:00', "db_files/test.db")
    hb.add_habit("Workout", 1, '2023-01-05 01:00:00', "db_files/test.db")
    hb.add_habit("Swim", 7, '2023-01-08 01:00:00', "db_files/test.db")
    hb.add_habit("Programming", 1, '2023-01-04 01:00:00', "db_files/test.db")
    hb.add_habit("Travel", 30, '2023-01-02 01:00:00', "db_files/test.db")
...
def test_mark_daily_as_complete_two_consecutive_days():
    hb.mark_habit_as_complete(1, '2023-01-02 01:00:00', "db_files/test.db")
    hb.mark_habit_as_complete(1, '2023-01-03 01:00:00', "db_files/test.db")
...
def test_mark_daily_as_complete_five_consecutive_days():
    hb.mark_habit_as_complete(2, '2023-02-02 01:00:00', "db_files/test.db")
    hb.mark_habit_as_complete(2, '2023-02-03 01:00:00', "db_files/test.db")
    hb.mark_habit_as_complete(2, '2023-02-04 01:00:00', "db_files/test.db")
    hb.mark_habit_as_complete(2, '2023-02-05 01:00:00', "db_files/test.db")
    hb.mark_habit_as_complete(2, '2023-02-06 01:00:00', "db_files/test.db")
...
def test_mark_habit_as_complete():
    hb.mark_habit_as_complete(4, "2023-01-08 01:00:00", "db_files/test.db")
    hb.mark_habit_as_complete(4, "2023-01-09 01:00:00", "db_files/test.db")
    hb.mark_habit_as_complete(4, "2023-01-10 01:00:00", "db_files/test.db")
    hb.mark_habit_as_complete(4, "2023-01-11 01:00:00", "db_files/test.db")
    hb.mark_habit_as_complete(4, "2023-01-13 01:00:00", "db_files/test.db")
    hb.mark_habit_as_complete(4, "2023-01-14 01:00:00", "db_files/test.db")
    assert db.get_updated_streaks(4) == (4, 4, 0, 4)


# test deleting a habit
def test_delete_habit():
    hb.delete_habit(1, "db_files/test.db")
